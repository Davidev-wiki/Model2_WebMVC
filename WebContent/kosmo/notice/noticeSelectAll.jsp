...
<script type="text/javascript">
	...
	$(document).ready(function(){	
		...
		// 등록하기 
		$("#I").click(function(){			
			location.href='/testKosmo/kosmo/notice/notice.html';			
		});
...
<tr>
	...
	<td class="tt"><img src="/testKosmo/fileupload/notice/<%= nvo.getNphoto() %> " border="1" width="25" height="25" alt="image"></td>
