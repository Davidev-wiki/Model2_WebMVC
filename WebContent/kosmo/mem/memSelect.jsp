...
<script type="text/javascript">
	...
	function memUpdate(actionUpdate){
		...
		if ('U' == actionUpdate){
			var v1 = "UOK";		
			document.memUpdateForm.action="/testKosmo/mem?ISUD_TYPE="+v1;			
		}
		
		if ('D' == actionUpdate){
			var v2 = "DOK";
			document.boardUpdateForm.action="/testKosmo/mem?ISUD_TYPE="+v2;
		}
...
<tr>
	...
	<td rowspan="5">
		<img class="photo" src="/testKosmo/fileupload/member/<%= mvo.getMphoto() %>" alt="image">
	</td>	
</tr>
<tr>
	<td>이름</td>
